...
async def search(
    ...
    pieces_min: int | None = Query(None, description="Nombre de pièces principales minimum."),
    ...
    params = DVFSearchParams(
        ...
        surface_terrain_min=surface_terrain_min,
        surface_terrain_max=surface_terrain_max,
